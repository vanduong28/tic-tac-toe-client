...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  ...
	  $(document).ready(game.hideBoard);
	  $(document).ready(game.hideNewGameBtn);
	  $(document).ready(game.hideButtons);
	  ...
	  $('#get-stats').on('submit', game.getPlayerStats);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var handleClick = function handleClick(event) {
	  ...
	  if (moveCount < 10) {
	    ...
	    var indexOfCellClicked = parseInt(cell[4]);
	    // update gameBoard array at index with letter
	    gameBoard[indexOfCellClicked] = currentPlayer;

	    // console.log(gameBoard)
	    // pass index to game object
	    gameApi.updateGame(indexOfCellClicked, currentPlayer).then(gameUi.updateGameSuccess).catch(gameUi.updateGameFailure);
	    ...
	    if (gameBoard[0] === gameBoard[1] && gameBoard[0] === gameBoard[2] || gameBoard[0] === gameBoard[3] && gameBoard[0] === gameBoard[6] || gameBoard[0] === gameBoard[4] && gameBoard[0] === gameBoard[8]) {
	    ...
	    } else if (gameBoard[2] === gameBoard[5] && gameBoard[2] === gameBoard[8] || gameBoard[2] === gameBoard[4] && gameBoard[2] === gameBoard[6]) {
	      if (gameBoard[2] === 'X') {
	        markGameWon(currentPlayer);
	        // console.log('X wins')
	      ...
	      // console.log('draw!')
	      gameApi.updateOver().then(gameUi.updateOverSuccess).catch(gameUi.updateOverFailure);
	    }
	  }
	...
	var markGameWon = function markGameWon(winnerLetter) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  gameApi.signUp(data).then(gameUi.signUpSuccess).catch(gameUi.signUpFailure);
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  var data = getFormFields(this);
	  gameApi.signIn(data).then(gameUi.signInSuccess).catch(gameUi.signInFailure);
	};
	...
	var getPlayerStats = function getPlayerStats(event) {
	  event.preventDefault();
	  // console.log('get player stats clicked')
	  gameApi.getStats().then(gameUi.getStatsSuccess).catch(gameUi.getStatsFailure);
	};

	var hideBoard = function hideBoard(event) {
	  $('.game-board').hide();
	};

	var hideNewGameBtn = function hideNewGameBtn(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateGame = function updateGame(index, letter) {
	...
	var updateOver = function updateOver() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateOverSuccess = function updateOverSuccess() {
	  // console.log('update OVER to TRUE data is: ', data)
	};

	var updateOverFailure = function updateOverFailure() {
	  // console.error(error)
	};

	var getStatsSuccess = function getStatsSuccess(data) {
	  // console.log('stats displayed: ', data)
	  var gameTotal = Object.keys(data.games).length;
	...
	module.exports = {
	  ...
	  updateOverSuccess: updateOverSuccess,
	  updateOverFailure: updateOverFailure,
